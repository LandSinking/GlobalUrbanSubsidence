...
**Our monitoring results, including the land subsidence velocities, InSAR coherence, the standard deviation of velocities, and geographic locations of reference points for all 465 cities in this study can be accessed via [figshare archive](https://figshare.com/s/6690eab0d9d9af3841de), and visualized at [GUS portal](https://ee-pkurelab.projects.earthengine.app/view/gus).**
