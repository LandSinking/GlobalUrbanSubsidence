...
start_time=time()
ts_filename= "timeseries.tif"

datapth = os.path.join('.', city_name)
...
sio.savemat(os.path.join(datapth, r"davies_test.mat"), {'change_point_par_Fflag': change_point_par_Fflag,
