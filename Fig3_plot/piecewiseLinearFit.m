...
change_point_par_RSSsl = nan(row,col);
vel = nan(row,col);
...
disp(strcat(icity, ": processing finished! "));
save(strcat('.\', icity, '\piecewise.mat'), ...
...
disp(strcat(icity, ": results saved!")); 
toc(t1);
