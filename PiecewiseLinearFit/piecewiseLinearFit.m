...
filePth = "D:\path\to\timeseries_files";
saveDir = "D:\path\to\piecewise_result\";

folders = dir(filePth);                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
folders = folders([folders.isdir] & ~ismember({folders.name}, {'.', '..'})); % exclude . and ..


for i=1:length(folders)    
    icity = folders(i).name;    
    load(fullfile(filePth, icity, 'dates.mat'), 'remainDate');
    dates_datetime = datetime(remainDate,'InputFormat','yyyyMMdd');
    dates_datenum = datenum(dates_datetime);
    ts = geotiffread(fullfile(filePth, icity, 'timeseries_f32.tif'));
    [row,col,~] = size(ts);
    ...
    parfor m = 1:row
        for n = 1:col
            ...
            x = x0/365.25; % year
            nanind= y>30000; %remove nan in series
            y(nanind) = [];
            x(nanind) = [];
